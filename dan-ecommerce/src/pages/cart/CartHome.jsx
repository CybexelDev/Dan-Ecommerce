...
import { getCart, removeCart } from '../../API/userApi'
...
function CartHome() {
  ...
  const handleDelete = (produtId) => {
    const data = removeCart(produtId, userId)
  ...
  console.log(cart, "cart data >>>>>>> 55555555555555555");
  ...
  const handleQuantityChange = async (id, newQty) => {
    ...
    try {
      ...
      console.log("api calllllllllllllllllllllllllllllllllllllllll",userId, id, newQty);
      
      // API call to update DB
      // await axios.put(`/api/cart/updateQty`, {
      //   userId,
      //   cartItemId: id,
      //   quantity: newQty,
      // });
